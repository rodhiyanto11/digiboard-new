...
import indoData from "../../../asset/json/IndonesiaMap.json"
import Countries from "../../../asset/json/Countries.json"
...
const Dashboard = () => {
    ...
    const listpayor = {
        ...
        series: [
            ...
            {
                name: "Patient",
                data: [20, 30, 10, 90, 100, 20, 30, 10, 90, 100, 20, 30, 10],
            },
            {
                name: "Case",
                data: [60, 90, 80, 30, 10, 20, 30, 10, 90, 100, 20, 30, 10]
            },
        ],
        options: {
            colors: ['#3f51b5', '#F1B24A', '#d4526e', '#13d8aa', '#A5978B', '#2b908f', '#f9a3a4', '#90ee7e',
                '#f48024', '#69d2e7'
            ],
            ...
            xaxis: {
                ...
                categories: ["PT. ABC", "PT. DEF", "PT. HIJ", "PT. KLM", "PT. OPQ", "PT. ABC", "PT. DEF", "PT. HIJ", "PT. KLM", "PT. OPQ", "PT. ABC", "PT. DEF", "PT. HIJ"],
            },
            yaxis: {
                labels: {
                    align: 'left',
                        ...
                        <div className="col-md-4">
                            <div class="mb-2 card bg-white">
                                <div className="card-body " >
                                    ...
                                    key={state.keyMAP} 
                                        refs="map"
                                        style={{height: `${state.hight * 80 /100}px`}}
                                        zoom={3} center={[-1, 120]}
                                        >
                                        <GeoJSON
                ...
                <div className="col-md-12">
                    <div className="row">
                        <div className="col-md-12">
                            <div class="mb-2 card bg-white ">
                                <div className="card-body ">
                                    <strong><i>Real time data is taken from inpatient category with isolation, diagnose, other viral pneumonia, other corona virus as the case of diseases, classified else where, Acute bronchitis die to other spesific organism, Bronchitis not specified as acute or chronic, Unspecified acute lower respiratory distres syndrome encounter for observation for suspected exposure to other biological agents ruled out, contact with and (suspected) exposure to other viral communicable diseases</i></strong>
                                </div>
                            </div>
                        </div>
                    </div>
